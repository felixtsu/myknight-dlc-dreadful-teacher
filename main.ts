namespace myknight_felix_dlc {
    ...
    export function dreadfulTeacher() {
     Player.setPlayer(img`
        ...
        Player.setCharacterAnim(player2, Character.dirKind.right, Character.animKind.attack, [img`
            ...
            . . . . f f f . . . . . 
            `])
        Player.setDeflWeapon(player2, "灵魂的拷问")
    })
    Weapon.setWeapons("武器", function () {
        Weapon.setWeapon(img`
            ...
            ................................
            ................................
            `, "灵魂的拷问", function (weapon) {
            Player.getPlayer().say("为什么", 1000)
            ...
            Weapon.setWeaponDesc(weapon, "朱古力", "可以激发思考")
            ...
            Weapon.weaponSkill(weapon, function (tempVar, sprite) {
                Bullet.shoot(weapon, "为什么", weapon.x, weapon.y, 0, 75, 30, false)
                Bullet.shoot(weapon, "为什么", weapon.x, weapon.y, 0, 75, 15, false)
                Bullet.shoot(weapon, "为什么", weapon.x, weapon.y, 0, 75, 0, false)
            })
        })
    })
    Bullet.setProjectiles("弹射物", function () {
        Bullet.setProjectile(img`
            ...
            . . . b 1 1 f f f f 1 1 b d . . 
            . . . b 1 f f f f f f 1 b d . . 
            . . . b 1 f f 1 1 f f 1 b d . . 
            . . . b 1 1 1 1 f f f 1 b d . . 
            . . . b 1 1 1 f f f 1 1 b d . . 
            . . . b 1 1 1 f f 1 1 1 b d . . 
            . . . b 1 1 1 1 1 1 1 1 b d . . 
            . . . b 1 1 1 f f 1 1 1 b d . . 
            . . . b b b b b b b b b b . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            ...
            Bullet.setBullet(projectile, Bullet.bulletP.hitrec, 1000)
        })
    })
    Bullet.bulletOverlap("为什么", Bullet.overlapKind.two, function (projectile, otherSprite) {
        projectile.destroy()
        if (Enemy.getEnemyAttr(Enemy.spriteToEnemy(otherSprite), "被拷问次数") == -1) {
            Enemy.setEnemyAttr(Enemy.spriteToEnemy(otherSprite), "被拷问次数", 0)
        }
        if (Math.percentChance(50)) {
            Enemy.changeEnemyAttrBy(Enemy.spriteToEnemy(otherSprite), "被拷问次数", 1)
        } else {
            otherSprite.say("Y", 1000)
            Bullet.setHp(otherSprite, 10)
        }
        if (Enemy.getEnemyAttr(Enemy.spriteToEnemy(otherSprite), "被拷问次数") == 5) {
            otherSprite.destroy()
        } else {
            let str = ""
            for (let index = 0; index < Enemy.getEnemyAttr(Enemy.spriteToEnemy(otherSprite), "被拷问次数"); index++) {
                str = "" + str + "?"
            }
            otherSprite.say(str, 1000)
        }
    })
}
}
